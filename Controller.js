    ...
    var Controller = function() {
        this.setView = function() {
            setTimeout(function(){
                ...
                best.style.left = Global.game.offsetLeft - 140 + "px" ;
                best.style.top = Global.game.offsetTop + 20 + "px" ;
                var bonus = document.getElementById("bonus") ;
                bonus.style.left = Global.game.offsetLeft - 240 + "px" ;
                bonus.style.top = Global.game.offsetTop + 160 + "px" ;
                ...
                if( window.localStorage.best ) {
                    best.innerHTML = "best: <br />" + window.localStorage.best ;
                }
                else {
                    best.innerHTML = "best: " ;
                }
